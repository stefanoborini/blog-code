...
ALL_CODONS = ["IncA",  "IncX" , "LoadA", "LoadX", "LoadY", "AddYtoA", "MoveAtoY", "MoveAtoX", "BranchXZero", "BranchXNotZero", "Return"]


def generateRandomCodon():
    opcode = random.choice(ALL_CODONS)
    if opcode in ["AddYtoA", "MoveAtoY", "Return", "MoveAtoX"]:
        return (opcode, None)
    else:
...
class Bacterium(object):
    ...
    def feed(self,val):
        ...
        while True:
            ...
            print str(self._pc)+" : "+str(codon)+" # a = "+str(self._a)+" | x = "+str(self._x)+" | y = "+str(self._y)
...
class Environment(object):
    ...
    def __init__(self):
        ...
        for i in xrange(1,2000):
            #self._all_bacteria.append(Bacterium([("MoveAtoX", None), ("IncX", -1), ("MoveAtoY", None), ("AddYtoA", None), ("IncX", -1), ("BranchXNotZero", -3) ]))
